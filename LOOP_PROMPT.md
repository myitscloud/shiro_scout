# LOOP PROMPT — paste this any time the agent stalls, drifts, or you want another batch
...
5. **GOTO 2** — keep looping without asking, unless a STOP condition fires (SESSION_PROTOCOL §5). If out of work → STOP-1 report, then wait.

Constraints in force: max 2 concurrent subordinates (O12) · Linux container, Windows 11 target · FILEOPS.md for every edit · no invented work (DONE-050).
